export const topRowStacks = [
    { icon: "/stack/javascript.png", label: "Javascript", desc: "Typed JS" },
    { icon: "/stack/nextjs.png", label: "Next.js", desc: "React Framework" },
    { icon: "/stack/tailwind.png", label: "Tailwind CSS", desc: "CSS Utility" },
